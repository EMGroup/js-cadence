...
Cadence.UI.Gutter = function(parent, infob) {
	var me = this;
...
Cadence.UI.Gutter.prototype.clear = function() {
	this.ast = undefined;
	this.lines = [];
...
Cadence.UI.Gutter.prototype.setAgent = function(name) {
...
Cadence.UI.Gutter.prototype.executeSelected = function() {
...
Cadence.UI.Gutter.prototype.generate = function(ast, lineno) {
	this.ast = ast;
