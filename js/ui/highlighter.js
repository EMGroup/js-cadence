...
(function (global) {
	 ...
	 */
	Cadence.UI.Highlight = function(output) {
		this.ast = undefined;
	...
	Cadence.UI.Highlight.isType = function(str) {
		return false;
	 ...
	 */
	Cadence.UI.Highlight.prototype.highlightLine = function(ast, position) {
		var errstart = -1;
		var errend = -1;
		var errmsg = "";
		var inerror = false;
	 ...
	 */
	Cadence.UI.Highlight.prototype.highlight = function(ast, hline, position) {
		this.ast = ast;
		this.line = 1;
